...
export const PalettePanel: FC = () => {
  ...
  return (
    <div className="palette-section grid grid-rows-[auto_1fr] overflow-hidden">
      <div className="section-header px-3 py-2.5 font-bold bg-[#121521] border-b border-[#1f2535] sticky top-0 z-[2]">
        Palette
      </div>
      
      <div className="palette p-3 overflow-hidden">
        ...
        <div className="tilesetPreview bg-[#0c0f16] rounded-lg border border-dashed border-[#2b3247] h-full overflow-hidden relative">
          <PaletteCanvas />
        </div>
      </div>
    </div>
